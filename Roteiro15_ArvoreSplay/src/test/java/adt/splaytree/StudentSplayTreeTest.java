...
public class StudentSplayTreeTest {
	...
	public void testRemove_2() {
		...
		assertEquals(3, splay.size());
		assertArrayEquals(new Integer[] {0, 5, 120}, splay.preOrder());
		
		assertEquals((Integer) 0, splay.getRoot().getData());
		
		splay.remove(3);
		assertEquals((Integer) 5, splay.getRoot().getData());
		assertArrayEquals(new Integer[] {5, 0, 120}, splay.preOrder());
		
		assertEquals(NIL, splay.search(3));
		assertArrayEquals(new Integer[] {0, 5, 120}, splay.preOrder());
